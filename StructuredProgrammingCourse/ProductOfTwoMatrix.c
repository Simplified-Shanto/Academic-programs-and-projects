...
// Here array of pointers - where each pointer points to the memory blocking containing the entire row. approach is followed
// Note that this version of array implementation with pointer is most convenient to use.
...
//     int **productMat = malloc(r1 * sizeof(int *));

//     for (int i = 0; i < r1; i++)
//     {
//         productMat[i] = malloc(c2 * sizeof(int));
//     }
...
// // Following implementation follows pointer to contiguous memory approach.
// #include<stdio.h>
// #include<stdlib.h>
...
//     int *mat1 = malloc(r1 * c1 *sizeof(int)); //Using single pointer pointing at a contiguous block of memory for representing 2D array.
...
//     int *mat = malloc(r1 * c2 * sizeof(int));
...
//             for (int i = 0; i < c1; i++)
//             {
//                 productSum += (*(mat1 + mat1rowIndex * c1 + i))*(*(mat2 + i * c2 + mat2columnIndex));
//             }
//             *(mat + mat1rowIndex * r1 + mat2columnIndex) = productSum;
//         }
//     }
